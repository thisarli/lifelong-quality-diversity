...
def get_fitness_score(ind, nn_list):
    ...
    Computes the average excess fitness of individual vs its nearest neighbors
    '''
    c_sum = 0 
    for nn in nn_list:
...
def add_to_archive(s, archive, params):
    ...
    archive: list or dict of species individuals

    If s is more diverse or fitter than nearest neighbors above some threshold
    given by params, then return 1 (ie that s will be added to the archive)
    """
    ...
    # get fitness score difference vs nearest neighbors
