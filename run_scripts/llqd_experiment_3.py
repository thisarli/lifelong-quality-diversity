...
# python3 run_scripts/llqd_experiment_3.py --log_dir results/experiment_3/200_easy --dump_period 500000 --epsilon 0.5 --min_model_add 200 --random_init_batch 200 --high_difficulty 0
# python3 run_scripts/llqd_experiment_3.py --log_dir results/experiment_3/200_diff --dump_period 500000 --epsilon 0.5 --min_model_add 200 --random_init_batch 200 --high_difficulty 1

# python3 run_scripts/llqd_experiment_3.py --log_dir results/experiment_3/50_easy --dump_period 500000 --epsilon 0.5 --min_model_add 50 --random_init_batch 50 --high_difficulty 0
